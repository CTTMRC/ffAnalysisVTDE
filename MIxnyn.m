...
if Nx~=Ny
    ...
    fprintf('Calculation using the %d datapoints',N);
...
fzwsp=[x;y]';
save zwspMIxnyn.txt fzwsp -ascii


% execute C Programm
[~, unout]=system(['\\ad.local\dfs\AAS-Users\marco.cattaldo\Documents\MATLAB\Code.Repository\MIxnyn.exe zwspMIxnyn.txt ',num2str(Ndx),' ',num2str(Ndy),' ',num2str(N),' ',num2str(kneig)]);
% miout=unout;
miout=max(0,str2double(unout));
